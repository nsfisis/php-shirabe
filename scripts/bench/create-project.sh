...
hyperfine \
  ...
  --ignore-failure \
  "'$BIN' create-project --profile --no-plugins --no-scripts '$PACKAGE' '$TARGET_DIR-shirabe'" \
  "composer create-project --profile --no-plugins --no-scripts '$PACKAGE' '$TARGET_DIR-composer'"
